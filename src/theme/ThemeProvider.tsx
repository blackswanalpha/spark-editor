...
type ThemeCtx = {
  theme: ThemeId;
  resolved: "light" | "dark" | "navy" | "amber" | "red"; // navy/amber/red never collapse
...
function resolveTheme(t: ThemeId): "light" | "dark" | "navy" | "amber" | "red" {
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const [resolved, setResolved] = useState<"light" | "dark" | "navy" | "amber" | "red">(() => resolveTheme(theme));
